...
module.exports = (app, es) => {
    ...
    /** 
     * Collect suggested terms for a given field based on a given query. Example: /api/suggest/authors/lipman
     */
     ...
     app.get('/api/suggest/:field/:query', (req, res) => {
         ...
         rp({url, json: true, body: esReqBody}).then(esResBody => res.status(200).json(esResBody.suggest.suggestions))
